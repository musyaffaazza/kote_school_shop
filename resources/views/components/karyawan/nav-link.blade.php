...
@php
    $baseClasses = 'flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-semibold transition-all duration-200';
    $activeClasses = $active
        ? 'bg-[#3d2a1f] text-white shadow-md'
        : 'text-[#9b8a7b] hover:bg-[#2a1f1a] hover:text-white';
@endphp
